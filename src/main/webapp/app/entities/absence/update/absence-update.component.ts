...
export class AbsenceUpdateComponent implements OnInit {
  ...
  protected updateForm(absence: IAbsence): void {
    ...
    this.eCSSharedCollection = this.eCService.addECToCollectionIfMissing(this.eCSSharedCollection, absence.eC);
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.eCService
      ...
      .pipe(map((eCS: IEC[]) => this.eCService.addECToCollectionIfMissing(eCS, this.editForm.get('eC')!.value)))
