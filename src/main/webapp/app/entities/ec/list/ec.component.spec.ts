...
describe('EC Management Component', () => {
  let comp: ECComponent;
  let fixture: ComponentFixture<ECComponent>;
  let service: ECService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ec', component: ECComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.eCS?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
