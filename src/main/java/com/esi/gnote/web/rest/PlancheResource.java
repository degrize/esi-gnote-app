...
public class PlancheResource {
     ...
     */
    @GetMapping("/planches")
    public ResponseEntity<List<PlancheDTO>> getAllPlanches(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Planches");
        Page<PlancheDTO> page = plancheService.findAll(pageable);
