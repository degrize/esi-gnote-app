...
/**
 * REST controller for managing {@link com.esi.gnote.domain.Jury}.
 */
@RestController
@RequestMapping("/api")
public class JuryResource {
     ...
     */
    @GetMapping("/juries")
    public ResponseEntity<List<JuryDTO>> getAllJuries(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
