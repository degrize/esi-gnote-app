...
public class InspecteurResource {
    ...
    public ResponseEntity<List<InspecteurDTO>> getAllInspecteurs(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Inspecteurs");
        Page<InspecteurDTO> page = inspecteurService.findAll(pageable);
