...
/**
 * REST controller for managing {@link com.esi.gnote.domain.Soutenance}.
 */
@RestController
@RequestMapping("/api")
public class SoutenanceResource {
    ...
    public ResponseEntity<List<SoutenanceDTO>> getAllSoutenances(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Soutenances");
        Page<SoutenanceDTO> page = soutenanceService.findAll(pageable);
