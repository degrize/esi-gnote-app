...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.esi.gnote.domain.Note.class.getName() + ".eCS");
            ...
            createCache(cm, com.esi.gnote.domain.Professeur.class.getName() + ".eCS");
            ...
            createCache(cm, com.esi.gnote.domain.Filiere.class.getName() + ".uES");
            ...
            createCache(cm, com.esi.gnote.domain.Classe.class.getName() + ".eCS");
            ...
            createCache(cm, com.esi.gnote.domain.EC.class.getName() + ".professeurs");
            createCache(cm, com.esi.gnote.domain.EC.class.getName() + ".notes");
            createCache(cm, com.esi.gnote.domain.EC.class.getName() + ".classes");
            createCache(cm, com.esi.gnote.domain.UE.class.getName());
            createCache(cm, com.esi.gnote.domain.UE.class.getName() + ".eCS");
            createCache(cm, com.esi.gnote.domain.UE.class.getName() + ".filieres");
