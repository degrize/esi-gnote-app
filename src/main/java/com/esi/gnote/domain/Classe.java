...
public class Classe implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "rel_classe__ec", joinColumns = @JoinColumn(name = "classe_id"), inverseJoinColumns = @JoinColumn(name = "ec_id"))
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public Classe eCS(Set<EC> eCS) {
        this.setECS(eCS);
        return this;
    }

    public Classe addEC(EC eC) {
        this.eCS.add(eC);
        eC.getClasses().add(this);
        return this;
    }

    public Classe removeEC(EC eC) {
        this.eCS.remove(eC);
        eC.getClasses().remove(this);
        return this;
    }
