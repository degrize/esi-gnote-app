...
public class UE implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "uE", "professeurs" }, allowSetters = true)
    ...
    public void setECS(Set<EC> eCS) {
        if (this.eCS != null) {
            this.eCS.forEach(i -> i.setUE(null));
        }
        if (eCS != null) {
            eCS.forEach(i -> i.setUE(this));
        }
        this.eCS = eCS;
    }

    public UE eCS(Set<EC> eCS) {
        this.setECS(eCS);
        return this;
    }

    public UE addEC(EC eC) {
        this.eCS.add(eC);
        eC.setUE(this);
        return this;
    }

    public UE removeEC(EC eC) {
        this.eCS.remove(eC);
        eC.setUE(null);
        return this;
    }
