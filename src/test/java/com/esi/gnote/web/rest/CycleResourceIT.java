...
class CycleResourceIT {
    ...
    private static final String DEFAULT_NOM_CYCLE = "AAAAAAAAAA";
    private static final String UPDATED_NOM_CYCLE = "BBBBBBBBBB";
    ...
    void getAllCycles() throws Exception {
        ...
        restCycleMockMvc
            ...
            .andExpect(jsonPath("$.[*].nomCycle").value(hasItem(DEFAULT_NOM_CYCLE)));
    }
    ...
    void getCycle() throws Exception {
        ...
        restCycleMockMvc
            ...
            .andExpect(jsonPath("$.nomCycle").value(DEFAULT_NOM_CYCLE));
    }
